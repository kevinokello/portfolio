      ...
      >
        <div className=" mx-auto flex lg:flex-nowrap flex-wrap">
          ...
          <div className="lg:w-1/3  w-full md:py-8 mt-8 md:mt-0">
            <h2 className="text-lg mb-1 font-bold title-font">Form Is Here</h2>
            <p className="leading-relaxed mb-5 text-sm  text-textSecondary dark:text-textSecondary">
              You can talk to me by flling this form. I will try my best to get
              back to you.
            </p>
            <form onSubmit={handleOnSubmit} className="flex flex-col">
              ...
              <button
                ...
                className={`disabled:bg-paper dark:disabled:bg-paperDark text-white text-center bg-primary hover:bg-secondary focus:outline-none outline-none font-medium rounded-lg text-sm p-1 px-1.5 m-1 md:px-3 md:py-2 transition-all duration-300`}
              >
                Submit
              </button>
            </form>
