        ...
        <div className="flex sm:flex-row justify-center flex-col px-4">
          ...
          <div className="w-full sm:w-1/2">
            ...
            <p className="leading-relaxed text-textSecondary text-xs md:text-sm dark:text-textDarkSecondary">
              ...
              immensely, so if you want to join I am waiting for you ; As a
              Jack of All Trades, I'm curious to learn more about new
              technologies. <br></br>Always woke and motivated to drive meaningful levels
